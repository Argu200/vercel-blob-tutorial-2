...
export default async function Gallery() {
  ...
  const images = blobs; // or: blobs.filter(b => /\.(png|jpe?g|webp|gif|bmp|tiff|avif)$/i.test(b.pathname));
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            href="/"
            className="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded"text-center py-12 bg-white rounded-xl shadow-lg">
